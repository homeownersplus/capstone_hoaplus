                            ...
                            foreach ($db->query($sql) as $row) {
                                ...
                                <tr>
                                   ...
                                   <td><?php echo $row['position']; ?></td>
                                    <td>
                                        <a href="#edit_<?php echo $row['id']; ?>" class="btn btn-primary btn-sm" data-bs-toggle="modal"> Edit</a>
                                        <a href="#delete_<?php echo $row['id']; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="modal"> Delete</a>
                                    </td>
