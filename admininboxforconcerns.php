				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							...
							<button id="signout_button" id="view-compose-modal" onclick="viewmodal()" class="btn btn-primary"
								style="float: right;">Compose</button>
					...
					<!-- Modal -->
					<div class="modal fade" id="compose-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<div class="mb-3">
										<textarea class="form-control" placeholder="Message" id="compose-message" style="height: 100px"
											required></textarea>
									</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<div class="mb-3">
										<textarea class="form-control" placeholder="Compose Reply Message" id="reply-message"
