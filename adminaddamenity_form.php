								...
								<form name="insertrecord" method="POST" enctype="multipart/form-data">
									...
									<div style="margin-top:2%; margin-left:10%;">
										...
										<input class="form-control" type="file" name="image" accept="image/*" onchange="readURL(this, '')"
											style="margin-left: -0.2%; width:50%;" required>
									</div>
									<!----------for post title---------->
									<div class="mb-3" style="margin-top:2%; margin-left:10%; ">
										<label for="amename" class="form-label">Amenity Name</label>
										<input type="text" class="form-control" name="amename" aria-describedby="emailHelp"
									...
									<div class="row" style="margin-top:1%">
										<div class="mb-3">
											<input class="btn btn-primary" type="submit" value="Save" name="insert" style="margin-left:10%; ">
