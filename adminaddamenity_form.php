<?php
    ...
    if(isset($_POST['insert'])){
        ...
        $file = basename($filename);
          ...
          $amename=$_POST['amename'];
          $amendesc=$_POST['amendesc'];
          ...
          $model->addAment($unique, $amename, $amendesc);       // , $amendesc
          $_SESSION['message'] = 'Cheers! Amenity added successfully';   
					echo "<script>window.location.href='admin_addamenities.php?postadded'</script>";
...
<li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="mr-2 d-none d-lg-inline text-gray-600 small">Renato Adriano</span>
...
<!-- End of Topbar -->
    ...
    <div class="container-fluid">
          ...
          <div class="card-tools"> -->
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Add new Amenity</h1>
          ...
          <div class="card-tools">
            <form name="insertrecord" method="POST" enctype="multipart/form-data">
                ...
                <label class="col-form-label"><b>Amenity Image</b></label>
                  ...
                  <!----------for post title---------->
                   <div class="mb-3" style="margin-top:2%; margin-left:10%; " >
                    ...
                    <input type="text" class="form-control" name="amename" aria-describedby="emailHelp" style="width:50%;" required>
                ...
                <textarea class="form-control" placeholder="amendesc" name="amendesc" style="height: 100px" required></textarea>
...
<!----------for post buttons---------->
                <div class="row" style="margin-top:1%">
                    <div class="mb-3">
                       <input class="btn btn-primary" type="submit" value="Add Amenity" name="insert" style="margin-left:10%; ">
