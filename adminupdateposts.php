...
<!--------------------------- Update Form ----------------------------->
                            ...
                            <td><img src="./assets/images/<?php echo $row['Photo']; ?>.jpg" style=" margin-left: -1px; width: 150px;height: 150px; object-fit: cover;"></td>
                <label class="col-form-label"><b></b></label>
										<input class="form-control" type="file" name="image" accept="image/*" onchange="readURL(this, '')" style="border: 0px; padding: 3px; margin-top:3%;" required>
                </div>
                                <!--------------------------- Edit title ----------------------------->
                                  <div class="mb-3" style="margin-top:2%; margin-left:10%; " >
                                    <label for="ptitle" class="form-label">Announcement Title</label>
                                    <input type="text" class="form-control" name="ptitle" value="<?php echo $row['ptitle']; ?>" aria-describedby="emailHelp" style="width:50%;" required>
                                ...
                                <!--------------------------- edit post content ----------------------------->
                                         <div class="form-floating" style="margin-top:2%; margin-left:10%; width:45%;" >
                                                <textarea  name="pcontent"  class="form-control" style="height: 100px" required> <?php echo $row['pcontent']; ?></textarea>
                                        </div>
                     </div>
                </div>
			...
			?>  
                    <!--------------------------- buttons  ----------------------------->
                                            <div class="row" style="margin-top:1%">
                                                <div class="mb-3">
                                                    <input class="btn btn-primary" type="submit" value="Update Announcement" name="update"  style="margin-left:11%;" >
