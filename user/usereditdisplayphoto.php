						...
						<div class="card-body">
							<div class="userprofpic">
								<form name="updateuserprofilepic" method="POST" enctype="multipart/form-data">
									...
									<img src="../photos/profile.png" class="img-fluid rounded-circle"
									...
									<input class="form-control" type="file" name="image" accept="image/*" onchange="readURL(this, '')"
										style="border: 0px; padding: 3px; margin-top:3%; margin-top:10%; margin-left:2%;" required>


									<div class="mb-3" style="margin-top:10%;">
										<input class="btn btn-outline-primary" type="submit" value="Update Photo"
											name="updateuserprofilepic" style="margin-left:20%;">
